...
prompt Created by USER on Tuesday, May 28, 2024
set feedback off
set define off
...
alter table ASSIGNED_OPERATION disable constraint SYS_C008462;
alter table ASSIGNED_OPERATION disable constraint SYS_C008463;
prompt Disabling foreign key constraints for PERSONNEL...
alter table PERSONNEL disable constraint SYS_C008453;
prompt Disabling foreign key constraints for ASSIGNED_PERSONNEL...
alter table ASSIGNED_PERSONNEL disable constraint SYS_C008457;
alter table ASSIGNED_PERSONNEL disable constraint SYS_C008458;
prompt Disabling foreign key constraints for INTELLIGENCE_REPORTS...
alter table INTELLIGENCE_REPORTS disable constraint SYS_C008470;
prompt Disabling foreign key constraints for SUBMITS...
alter table SUBMITS disable constraint SYS_C008474;
alter table SUBMITS disable constraint SYS_C008475;
...
insert into ASSIGNMENTS (a_id, p_id, o_id, e_id, start_date, end_date)
...
alter table ASSIGNED_OPERATION enable constraint SYS_C008462;
alter table ASSIGNED_OPERATION enable constraint SYS_C008463;
prompt Enabling foreign key constraints for PERSONNEL...
alter table PERSONNEL enable constraint SYS_C008453;
prompt Enabling foreign key constraints for ASSIGNED_PERSONNEL...
alter table ASSIGNED_PERSONNEL enable constraint SYS_C008457;
alter table ASSIGNED_PERSONNEL enable constraint SYS_C008458;
prompt Enabling foreign key constraints for INTELLIGENCE_REPORTS...
alter table INTELLIGENCE_REPORTS enable constraint SYS_C008470;
prompt Enabling foreign key constraints for SUBMITS...
alter table SUBMITS enable constraint SYS_C008474;
alter table SUBMITS enable constraint SYS_C008475;
